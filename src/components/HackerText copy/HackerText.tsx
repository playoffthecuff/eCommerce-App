...
import styles from '../HackerText copy/HackerText.module.css';
...
export default function HackerText({ text, className, animationSpeed = 1, startDelay = 0, threshold = 0.5 }: Props) {
